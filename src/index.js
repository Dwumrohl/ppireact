...
export const Navbar = () => (
    ...
    export function About() {
        return(
            <div className="about">
                <ul id="listAbout">
                    <li><p>Это одностраничное веб-приложение, для просмотра новостей космической тематики, на основе React</p></li>
                    <li><p>В процессе использовались языки: JavaScript, CSS, HTML</p></li>
                    <li><p>Выполнил студент группы РПИС-92, Плошкин Павел</p></li>
                </ul>
            </div>
